...
for player_url in player_urls:
    try:
        ...
        # Try different methods to find the player name
        player_name = None
        ...
        if name_element:
            ...
            if name_span:
                ...
                # Try finding the strong tag within the scoreboard header
...
career_averages_df.to_csv('player_career_averages.csv', index=False)
